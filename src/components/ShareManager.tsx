...
export default function ShareManager() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      <h1 className="mb-2 font-display text-3xl font-semibold tracking-tight text-fg">Share links</h1>
              ...
              <li key={s.id} className="flex items-center gap-3 px-4 py-3">
                ...
                {status === 'active' ? (
                  <button
                    ...
                    className="px-2 text-[0.7rem] uppercase tracking-wider text-muted hover:text-accent"
                  >
                    Revoke
                  </button>
                ) : null}
