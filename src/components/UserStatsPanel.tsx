...
//
// Only two of these fields reach a metric: bodyweight prices unweighted work
// (a push-up stops costing a flat 40kg for everyone) and birth year supplies
// 220−age as the last-resort HR ceiling. Height, gender, body type and injuries
// are stored and read by nothing yet — the form says so rather than implying
// they do something.
//
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <p className="text-[0.7rem] text-muted">
        ...
        log a higher one. Height is stored for later and changes nothing today.
      </p>
      ...
      <div>
        ...
        <p className="mt-2 text-[0.7rem] text-muted">
          Recorded for your own reference. Nothing reads these yet.
        </p>
      </div>
